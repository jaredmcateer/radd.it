...
//	else if ($mode == "report") echo "nada.<br>";
	...
	if ($mode == "report") echo '<div class="row"><div class="col s12">';
	if ($mode == "report") echo "<table class='striped'><thead><tr><th>up</th><th>Date</th><th>Days<br>Between</th><th>Weeks<br>Between</th><th>YYMMDD<br>Between</th><th>Day of Year</th><th>Days Left</th><th>Matches</th><th style='text-align:left'>event</th></tr></thead><tbody>";
